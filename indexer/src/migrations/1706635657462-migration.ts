...
export class migration1706635657462 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "whitelist" ("generation" integer NOT NULL, "proof" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_365e5cf79f9365dc5eb3c4e4c25" PRIMARY KEY ("generation"))`);
